...
import TGMotionLowBattPic from '../../../../../pictures/2GIG-motion-inside-diagram.png'

function TGMotionLowBatt() {
    ...
    return (
        <animated.div className="sensor-container" style={props}>
            <h1>2GIG Low Battery</h1>
            <div className="sensor-wrapper">
                <img className="step-pic" src={TGMotionLowBattPic} alt="lunabatt"></img> 
...
export default TGMotionLowBatt
